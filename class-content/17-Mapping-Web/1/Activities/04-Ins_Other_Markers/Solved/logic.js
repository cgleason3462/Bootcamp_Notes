...
// Looks like a little green circle on the map, like AirBNB uses for address on the app
...
L.polygon([
    // Give the coordinates for the points on the polygon
    [45.54, -122.68],
    [45.55, -122.68],
    [45.55, -122.66]
], {
    color: "yellow",
    fillColor: "yellow",
    // the closer to 1 the darker the fill
    fillOpacity: 0.75
}).addTo(myMap);
