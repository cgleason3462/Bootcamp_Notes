...
// imdbRating is a attribute for each movie
function filterMovieRatings(movie) {
  return movie.imdbRating > 8.9;
}

// 2. Use filter() to pass the function as its argument
// "topMovies" is in the data.js file
...
// Use map to make an array with just the movie titles
...
// Use map to return an array with just the ratings
...
// 5. Create your trace.
// Use the arrays you made with map to create the axis
var trace = {
  x: titles,
  y: ratings,
  type: "bar"
